...
#Condicional
if(primero_en_tomar==obeja){print(resultado2)} else if (primero_en_tomar==lobo){print("si inicia con lobo, la obeja se comera el pasto")} else if(primero_en_tomar==pasto){print("Si inicia con el pasto, el lobo se comera a la obeja")} else {"Debe introducir Primero_en_tomar == lobo|pasto|obeja"}
#Iniciando con el lobo
primero_en_tomar<-lobo
if(primero_en_tomar==obeja){print(resultado2)} else if (primero_en_tomar==lobo){print("si inicia con el lobo, la obeja se comera el pasto")} else if(primero_en_tomar==pasto){print("Si inicia con el pasto, el lobo se comera a la obeja")} else {"Debe introducir Primero_en_tomar == lobo|pasto|obeja"}
#Iniciando con el pasto
primero_en_tomar<-pasto
if(primero_en_tomar==obeja){print(resultado2)} else if (primero_en_tomar==lobo){print("si inicia con el pasto, la obeja se comera el pasto")} else if(primero_en_tomar==pasto){print("Si inicia con el pasto, el lobo se comera a la obeja")} else {"Debe introducir Primero_en_tomar == lobo|pasto|obeja"}
#Caso de ErroR
primero_en_tomar<-56
